...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
  ...
  private void initializeModels() {
    ...
    exampleItemModels.add(new ExampleItemModel(
      R.id.nav_query_map,
      R.string.activity_query_drag_draw_title,
      R.string.activity_query_drag_draw_description,
      new Intent(MainActivity.this, FingerDrawActivity.class),
      null,
      R.string.activity_query_drag_draw_url, true, BuildConfig.MIN_SDK_VERSION));
